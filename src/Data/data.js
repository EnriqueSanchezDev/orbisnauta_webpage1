...
const SEOBANNER_DATA = {
    PREHEADING: "+6 Years Developing Unforgettable Digital Experiences",
    HEADING: "More than a immersive content agency, a technological partner",
    DESCRIPTION_ONE: "Orbisnauta is a multi-industry immersive tech-agency with proficiency in the creation of state-of-the-art virtual experiences. Our vision consists of pushing the boundaries of spatial computing while being laser focused on providing true and quantifiable value to your brand.",
...
const INDUSTRIESBANNER_DATA = {
  ...
  INDUSTRY_2_2: "Accelerated proficiency",
  INDUSTRY_2_3: "Reduced training time",
  ...
  INDUSTRY_3_2: "Museum virtual clone",
  ...
  INDUSTRY_4_1: "3D modelling and measurements",
...
const STACKBANNER_DATA = {
  ...
  PLATFORMS_TEXT_1: "We work creating immersive content for the newest and best tethered and untethered VR headsets in the market.",
...
const SERVICESBANNER_DATA = {
  ...
  //SERVICES_DESCRIPTION_1_1: "1_111 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",
  ...
  //SERVICES_DESCRIPTION_2_1: "2_111 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",
  SERVICES_TITLE_2_2: "360 Stitching and Post-Production.",
  //SERVICES_DESCRIPTION_2_2: "2_2222 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",
  SERVICES_TITLE_2_3: "360 Photography and Tours.",
  //SERVICES_DESCRIPTION_2_3: "2_33333 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",

  SERVICES_HEADING_3: "AR/MR Development",
  SERVICES_TITLE_3_1: "WebXR Development.",
  //SERVICES_DESCRIPTION_3_1: "3_111 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",
  SERVICES_TITLE_3_2: "Headset MR App Development.",
  //SERVICES_DESCRIPTION_3_2: "3_2222 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",
  SERVICES_TITLE_3_3: "AR Web App Development.",
  //SERVICES_DESCRIPTION_3_3: "3_33333 It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the, though the transition does limit overflow.",
  ...
  //SERVICES_HEADING_2: "360VR Filmmaking"
  //SERVICES_HEADING_2: "VR Development"
  //DESCRIPTION: "Industries Orbisnauta is an end-to-end mixed reality agency helping brands build cutting-edge experiences from concept to deployment. Whether you need a completely custom experience or you want to take advantage of our existing frameworks, we'll help you build world class experiences without breaking the bank.",
  //RECENT: "Industries Recent Completed XR Projects"
}
